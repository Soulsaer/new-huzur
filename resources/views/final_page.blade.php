...
<div class="container mt-5">    
    <h2>Checkout</h2>
    <div class="row">
        <span class="pb-3"> <a href="login.html" class="line">Sign In </a> to checkout faster or  <a href="login.html" class="line">Create an Account </a> to manage your order on the go!</span>
        <div class="col-lg-8 py-2">
            <div class="card p-3">
                <form action="" class="form_buy_now" id="billingForm">
                    @csrf
                    ...
                    <div class="fields fields--2">
                        <label class="field">
                          ...
                          <input type="text" class="form-control" name="firstname" id="firstname" name="First Name" required>
                        </label>
                        <label class="field">
                      ...
                      <div class="fields fields--2">
                        <label class="field">
                          ...
                          <input class="field__input" type="email" name="email" id="email" placeholder="Email" />
                        </label>
                        <label class="field">
                          <span class="text" for="lastname">Phone Number</span>
                          <input class="field__input" type="text" name="phone" id="phone" placeholder="Phone Number" />
                        </label>
                      </div>
                    ...
                    <div class="fields fields--2">
                        <label class="field">
                          ...
                          <input class="field__input" type="text" name="pincode" id="Pincode" placeholder="Pin code" />
                        </label>
                        <label class="field">
                          <span class="text" for="city">City</span>
                          <input class="field__input" type="text" name="city" id="city"  placeholder="City"/>
                        </label>
                    ...
                    <div class="fields fields--2">
                        ...
                        <label class="field">
                            ...
                            <input class="field__input" type="text" name="address" id="address" placeholder="Address" />
                          </label>
                      </div>
                </form>
                <div class="d-flex align-items-center">
                    <input type="checkbox" class="input_checkbox" name="" id="">
                    <span class="ps-2">Billing address same as shipping address</span>
                </div>
                <div class="d-flex align-items-center">
                    <input type="checkbox" class="input_checkbox" name="" id="">
                    <span class="ps-2 pb-3">Sign up to receive offer emails and texts from Angara</span>
                </div>
                <div class="w-100 view_detail">
                    <button class=" mb-3 hover-up" id="saveBilling">
                        <span class="ps-3">Continue To Payment</span>
                        <span class="fas fa-arrow-right ms-2"></span>
                    </button>
                    <button id="rzp-button1" class="btn btn-outline-dark btn-lg" style="display: none;"><i class="fas fa-money-bill"></i> Pay With Razorpay</button>
                    <a id="cod-pay" href="{{ route('buy_now_cod', ['order_id'=> $order->id]) }}" class="btn btn-outline-dark btn-lg" style="display: none;"><i class="fas fa-money-bill"></i> COD</a>
                </div>
            </div>
            <!--  -->
            <!--  -->
                                ...
                                <div class="row gx-3">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <input class="form-control_1 mb-3" type="text" placeholder="Enter Your UPI ID">
                                        </div>
                                    </div>
                                    <div class="col-12">
            ...
            <div class="col-lg-4 py-2">
                <div class="card p-4">
                    <div class="d-flex  justify-content-between align-items-center  py-2 px-3 mb-2" style="background: #fcbba4; color: #000;" >
                    ...
                    <div class="detail_payment d-flex justify-content-between pt-3">
                        ...
                        <span class="title_red">${{ @$product->price ?? $totalOrderAmount}}</span>
                    </div>
                    <div class="detail_payment d-flex justify-content-between pt-3">
                    ...
                    <div class="detail_payment d-flex justify-content-between pt-3">
                        ...
                        <span class="title_red">Free<span style="text-decoration: line-through;color: #fcbba4;" class="ps-2">Free</span> </span>
                    </div>
                    ...
                    <hr>
                    <div class="detail_payment d-flex justify-content-between align-items-center    " style="border-top: 1px solid var(--darklight);">
                    ...
                    <span class="title_card"><i class="fa-solid fa-lock"></i> Secure Checkout Shopping is always <span class="line"> safe and secure</span>.</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="card py-3">
            ...
            <div class="col-lg-4 col-md-6 m-auto d-block text-center py-3 payment_card">
                <img src="https://images.mamaearth.in/wysiwyg/delivery2x.png" class="m-auto d-block my-2" style="width: 60px; height: 60px;" alt="payment_img">
                <h5 class="title_card">Free Shipping</h5>
                <span>On Order Above Rs. 599</span>
            </div>
            <div class="col-lg-4 col-md-6 m-auto d-block text-center py-3 payment_card">
                <img src="https://images.mamaearth.in/wysiwyg/Group_81512x.png" class="m-auto d-block my-2" style="width: 60px; height: 60px;" alt="payment_img">
        ...
        <div class="container">
            <div class="card py-3 px-4">
                ...
                <div class="col-lg-8">
                    ...
                    <span><i class="fa-solid fa-check me-1 item-icon_1" style="background-color: var(--main-color);"></i> 100% Payment Protection, Easy Return Policy</span>
...
$(document).ready(function () {
    ...
    $("#saveBilling").click(function () {
        ...
        // Send an Ajax request with the CSRF token in the header
        $.ajax({
            type: "POST",
            url: "{{ route('billing_detail_store') }}",
            data: formData,
            headers: {
    ...
    var options = {
        "key": "rzp_test_vtuhWI0EEHp5N6", // Replace with your Razorpay key
        "amount": {{ intval((@$product->price ?? $totalOrderAmount) * 100) }},
        "currency": "INR",
        "description": "Huzzur",
        "image": "https://huzurr.com/assets/images/logologo.png",
        "prefill": {
