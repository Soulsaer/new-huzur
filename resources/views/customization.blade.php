...
@section('content')
    ...
    <main class="">
        <section class="custm-banner lazy" data-was-processed="true"
            style="background-image:url(https://cdn.shopify.com/s/files/1/0129/3622/files/17.jpg?v=1517850328);background-size: 100% 100% ;">
            <div class="container">
                <aside>
                ...
                <div class="bg-white p-4 py-3 rounded  shadow-lg ">
                    <form action="" class="row justify-content-between">
                        <input type="text" placeholder="Name" class="my-2  col-lg-12">
                        <input type="email" placeholder="Email" class="my-2  col-lg-5">
                        <input type="number" placeholder="Mobile" class="my-2  col-lg-5">
                        <input type="file" placeholder="Mobile" class="my-2  col-lg-12 form-control">
                        <textarea cols="10" rows="1" placeholder="Description" class="col-lg-12"
                            style="min-height: 100px;"></textarea>
                        <div class="d-flex justify-content-center align-items-center py-3 view_detail w-100 hover-up">
                            <a href="javascript:void(0)" class="d-block m-auto fs-6 w-100 text-center">Submit<i
...
<!-- 
        <section class="custome-imagine container">
            <div class="custom-heading">If you can Imagine it?<span> We can Make it!</span></div>
            <ul>
                <li><img src="https://www.woodenstreet.com/images/custom-furniture/share.svg"><span>Share your
                        Idea</span>
                    Our furniture designers understand your requirements closely to craft a perfect piece.
                </li>
                <li><img src="https://www.woodenstreet.com/images/custom-furniture/designing.svg"><span>Designing</span>
                    Your idea is converted into a workable 3D design for further approvals and confirmations.
                </li>
                <li><img
                        src="https://www.woodenstreet.com/images/custom-furniture/manufacturing.svg"><span>Manufacturing</span>
                    As soon as our team receives the confirmation, manufacturing is initiated for your custom furniture.
                </li>
                <li><img src="https://www.woodenstreet.com/images/custom-furniture/delivery.svg"><span>Delivery</span>
                    Each custom order is treated with high priority &amp; we ensured to deliver it on time.
                </li>
            </ul><a onclick="$('#customize-form').swpmodal({closeOnEsc: false,
            closeOnOverlayClick: false});getCustomPopup();" href="javascript:;" class="btn btn_common">Customize
                Now</a>
        </section> -->
        ...
        <div class="mx-1">
            <h1 class="homepage_heading pt-80">{{ $processData->title }}</h1>
            <!-- <h3 class="fs-5">{{ $processData->tag_line }}</h3> -->
            <p style="font-size: 16px;" class="mb-4">{{ $processData->tag_line }}</p>
        </div>
            ...
            <div class="row m-0">
                <div class="col-lg-6 col-12" style="max-height: 400px;">
                    <img class="w-100 h-100" style="object-fit: cover;"
                        src="{{ asset('storage/'.$processData->section_1_image) }}" alt="{{ $processData->section_1_image_alt }}" />
                </div>
                <div class="col-lg-6 p-0 pe-2">
                    <div class="p-5">
                        <h3 class="fs-4"><span class="display-1" style="color:#4ed9ff;line-height: 1px;"></span><strong>1.</strong> {{ $processData->section_1_title }}</h3>
                        <div class="fs-6 mt-4">{!! $processData->section_1_content !!}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background-image: url(./background-image-huzur.jpg);">
            <div class="py-80">
                <div class="row m-0">
                    <div class="col-lg-6 p-0 pe-2">
                        <div class="p-5">
                            <h3 class="fs-4"><span class="display-1" style="color:#4ed9ff;line-height: 1px;"></span><strong>2.</strong> {{ $processData->section_2_title }}</h3>
                            <div class="fs-6 mt-4">{!! $processData->section_2_content !!}</div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12" style="max-height: 400px;">
                        <img class="w-100 h-100" style="object-fit: cover;"
                            src="{{ asset('storage/'.$processData->section_2_image) }}" alt="{{ $processData->section_2_image_alt }}" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="py-80">
            <div class="row m-0">
                <div class="col-lg-6 col-12" style="max-height: 400px;">
                    <img class="w-100 h-100" style="object-fit: cover;"
                        src="{{ asset('storage/'.$processData->section_3_image) }}" alt="{{ $processData->section_3_image_alt }}" />
                </div>
                <div class="col-lg-6 p-0 pe-2">
                    <div class="p-5">
                        <h3 class="fs-4"><span class="display-1" style="color:#4ed9ff;line-height: 1px;"></span><strong>3.</strong> {{ $processData->section_3_title }}</h3>
                        <div class="fs-6 mt-4">{!! $processData->section_3_content !!}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background-image: url(./background-image-huzur.jpg);">
            <div class="py-80">
                <div class="row m-0">
                    <div class="col-lg-6 p-0 pe-2">
                        <div class="p-5">
                            <h3 class="fs-4"><span class="display-1" style="color:#4ed9ff;line-height: 1px;"></span><strong>4.</strong> {{ $processData->section_4_title }}</h3>
                            <div class="fs-6 mt-4">{!! $processData->section_4_content !!}</div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12" style="max-height: 400px;">
                        <img class="w-100 h-100" style="object-fit: cover;"
                            src="{{ asset('storage/'.$processData->section_4_image) }}" alt="{{ $processData->section_4_image_alt }}" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="py-80">
            <div class="row m-0">
                <div class="col-lg-6 col-12" style="max-height: 400px;">
                    <img class="w-100 h-100" style="object-fit: cover;"
                        src="{{ asset('storage/'.$processData->section_5_image) }}" alt="{{ $processData->section_5_image_alt }}" />
                </div>
                <div class="col-lg-6 p-0 pe-2">
                    <div class="p-5">
                        <h3 class="fs-4"><span class="display-1" style="color:#4ed9ff;line-height: 1px;"></span><strong>5.</strong> {{ $processData->section_5_title }}</h3>
                        <div class="fs-6 mt-4">{!! $processData->section_5_content !!}</div>
                    </div>
                </div>
        ...
        <section class="custom-make">
            ...
            <article>
                <ul>
                    <li><label>Process</label><span><img
                                src="https://www.woodenstreet.com/images/custom-furniture/bad.svg">Manufacturer</span><span><img
                                src="https://www.woodenstreet.com/images/custom-furniture/warehouse.svg">Wholesaler</span><span><img
                                src="https://www.woodenstreet.com/images/custom-furniture/retailer.svg">Retailer</span><span><img
                                src="https://www.woodenstreet.com/images/custom-furniture/truck.svg">Customer</span>
                    </li>
                    <li><label>The Market Model</label><span>Rs 500</span><span>Rs 700</span><span>Rs 1000</span>
                        <p><strong>Rs 2000</strong> Everyone in the chain adds to the cost, which you end up paying for
                        </p>
                    </li>
                    <li><label class="makmodal">Huzurr <br> Model</label><span>Rs 500</span><span
        ...
        <!--  -->
        <div style="background-image: url(./background-image-huzur.jpg);padding-bottom: 80px;">
            <div class="slider2 pt-80" >
                <h1 class="homepage_heading mb-4 ms-3">{{ $sectionData->mto_section_title }}</h1>
                <div class="slide-track2" style="overflow:hidden">
                    <div class="slide2 mx-1">
                        <img src="assets/images/198289CZ_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/198421C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/198421C02_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/198863C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/297822_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/298311CZ_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/298427C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/298820C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/298876C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/398283_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide2 mx-1">
                        <img src="assets/images/399410C00_RGB (1).jpg" 100%="250" 100%="900" alt="" />
                    </div>
                </div>
            </div>
            <!--  -->
            <div class="mt-5" style="overflow:hidden">
                <div class="slide-track" style="overflow:hidden">
                    <div class="slide mx-1">
                        <img src="assets/images/590200_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/590728_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/590742HV_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/590745CBK-D_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/590745CBK-D_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/599046C01_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/599539C00_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    <div class="slide mx-1">
                        <img src="assets/images/198289CZ_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                    ...
                    <div class="slide mx-1">
                        <img src="assets/images/399410C00_RGB.jpg" height="100%" width="100%" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="mid-section">
            ...
            <aside>
                ...
                <a class="btn btn_common">Customize
                    Now</a>
            </aside>
        </section>
        ...
        <!--  -->
        <div class="py-80">
            <h1 class="homepage_heading text-start ms-3">{{ $sectionData->team_section_title }}</h1>
            <h3 class="fs-5 text-start ms-3">{{ $sectionData->team_section_tag_line }}</h3>
            <div class="row m-0">
                <div class="col-lg-3">
                    <div class="card my-5" style="width: 100%;">
                        ...
                        <div class="card-body">
                            <p class="fs-3 fw-bold mt-2 text-center text-dark">John Defargu</p>
                            <p class="fs-6 my-3 text-center">Meet the world's number 1 artisan team here, along
        ...
        <div class="mx-3 py-80">
            <h1 class="homepage_heading text-start ms-3">{{ $sectionData->workshop_section_title }}</h1>
            <h3 class="fs-5 mb-4 text-start ms-3">{{ $sectionData->workshop_section_tag_line }}</h3>
            <div class="gallery pt-4" style="background-color: white;">
                <img src="https://media.istockphoto.com/id/640933402/photo/adjusting-parts-of-earring.jpg?s=612x612&w=0&k=20&c=pmgvv53F-1scl5tq9DtlDviRcBlf9fgfdxkUUMN_7Rw="
                    alt="">
                <img src="https://m.media-amazon.com/images/I/61rd9gkg0LL._AC_UF1000,1000_QL80_.jpg" alt="">
                <img src="https://m.media-amazon.com/images/I/61lBhg3JelL._AC_UF894,1000_QL80_.jpg" alt="">
                <img src="https://www.shutterstock.com/image-photo/jewelry-designer-working-studio-tools-260nw-1743991166.jpg"
                    alt="">
                <img src="https://www.shutterstock.com/image-photo/professional-jewelry-designer-making-handmade-260nw-2023546928.jpg"
                    alt="">
                <img src="https://t4.ftcdn.net/jpg/03/88/06/09/360_F_388060902_ws6yAnsZReMecoQOZqKTkVUYncdnvgmi.jpg"
                    alt="">
                <img src="https://www.whpjewellers.com/images/blog/230116_120950_717_623.jpg" alt="">
                <img src="https://img.freepik.com/premium-photo/closeup-jewelry-designers-hands-working-with-beads-thread-created-with-generative-ai_124507-170057.jpg?size=626&ext=jpg&ga=GA1.1.1880011253.1699401600&semt=ais"
                    alt="">
            </div>
            ...
            <div class="">
                <div class="row m-0">
                    <div class="col-lg-12 m-0 p-0">
                        <h3 class="homepage_heading ms-3 text-start">{{ $sectionData->mto_section_title }}</h3>
                        <p class="fs-6 mb-4 text--center ms-3 text-start">{{ $sectionData->mto_section_tag_line }}</p>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 py-3 ph-md-0 d-flex align-items-start flex-column justify-content-center " style="background:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRE2h8-AjCDRTpTM3O6E1rmfBv6iS3R0GaHq2yC0RN_QXomTvh) no-repeat;background-size: cover;">
                                <h3 class="title_shop text-center">{{ $sectionData->mto_section_sub_title }}</h3>
                                <p class="para_shop text-center">{{ $sectionData->mto_section_sub_tag_line }}</p>
                                <div class="py-3 d-flex justify-content-end align-items-center view_detail hover-up mx-auto">
                                    <a href="{{ $sectionData->mto_section_btn_link }}" class="fs-6">{{ $sectionData->mto_section_btn_title }}<i
                                            class="fa-solid fa-angle-right ps-2"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div style="background-image: url(./background-image-huzur.jpg);">
            <div class="py-80">
                <h1 class="homepage_heading mb-4 text-start mx-3">{{ $sectionData->brjs_section_title }}</h1>
                <h3 class="mb-4 fs-5 text-start ms-3">{{ $sectionData->brjs_section_content }}
                </h3>
                <div class="slider">
                    <div class="slide-track">
                        <div class="slide mx-1" style="height: 100%;width:7%">
                            <a href="#" class="w-100">
                                <img src="https://logos-world.net/wp-content/uploads/2020/12/Etsy-Emblem.png" height="100%" width="100%" alt="" />
                            </a>
                        </div>
